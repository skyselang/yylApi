...
-- Records of ya_admin
-- ----------------------------
INSERT INTO `ya_admin` VALUES (1, 'yylAdmin', 'yyladmin@qq.com', 'yyladmin', '0827df0fd834daa31e9aec7396379033', '127.0.0.1', 33, '{\"os\":\"windows\",\"ie\":false,\"weixin\":false,\"android\":false,\"ios\":false}', 1554129161, 0, 0, 1553614274);
...
) ENGINE = MyISAM AUTO_INCREMENT = 89 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ya_relation`  (
  ...
  INDEX `project_id`(`project_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 37 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '项目用户关联' ROW_FORMAT = Dynamic;
...
INSERT INTO `ya_user` VALUES (1013, 'yyladmin', '0827df0fd834daa31e9aec7396379033', '127.0.0.1', 4, '{\"os\":\"windows\",\"ie\":false,\"weixin\":false,\"android\":false,\"ios\":false}', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2019-03-27 21:16:46', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00');
